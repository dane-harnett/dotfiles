...
M.attach_keymaps = function()
    ...
    utils.keymap("n", "<LEADER>tff", "<CMD>Telescope find_files<CR>")
    utils.keymap("n", "<LEADER>tdl", "<CMD>Telescope diagnostics<CR>")
    utils.keymap("n", "<LEADER>tfb", require("daneharnett.nvim-tree").toggle, "Toggle file browser")
    utils.keymap("n", "<LEADER>tgf", "<CMD>Telescope git_files<CR>")
    utils.keymap("n", "<LEADER>tht", "<CMD>Telescope help_tags<CR>")
    utils.keymap("n", "<LEADER>tgs", "<CMD>Telescope grep_string<CR>")
    utils.keymap("n", "<LEADER>tb", "<CMD>Telescope buffers<CR>")
    utils.keymap("n", "<LEADER>tlg", "<CMD>Telescope live_grep<CR>")
    utils.keymap("n", "<LEADER>tr", "<CMD>Telescope resume<CR>")
    utils.keymap("n", "<LEADER>tlgg", "<CMD>TelescopeLiveGrepWithGlobs<CR>")
    utils.keymap("n", "<LEADER>tipd", "<CMD>TelescopeInsertPathToDirectory<CR>")
end
